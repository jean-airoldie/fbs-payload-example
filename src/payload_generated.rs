...
impl<'a> Payload<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        args: &'args PayloadArgs<'args>) -> flatbuffers::WIPOffset<Payload<'bldr>> {
  ...
  pub fn messages(&self) -> Option<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Message<'a>>>> {
    self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<flatbuffers::ForwardsUOffset<Message<'a>>>>>(Payload::VT_MESSAGES, None)
  }
}
...
impl<'a: 'b, 'b> PayloadBuilder<'a, 'b> {
  ...
  pub fn add_messages(&mut self, messages: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Message<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Payload::VT_MESSAGES, messages);
  }
  #[inline]
